...
const ProjectOne=()=>{const ProjectData={};const projectsData=ProjectData.allProjectJson.edges.filter(data=>data.node.is_featured==true);return/*#__PURE__*/index_js_default().createElement("div",{className:"row row--25"},projectsData.map(data=>/*#__PURE__*/index_js_default().createElement(projectcard,{key:data.node.id,column:"col-lg-4 col-md-6 col-12",portfolioStyle:"portfolio-style-1",key:data.node.id,id:data.node.id,image:data.node.featured_image.childImageSharp,title:data.node.title,category:data.node.category,concept:data.node.concept,role:data.node.role})));};/* harmony default export */ const projectOne = (ProjectOne);
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-faf3be2cfdbeb5418fa6.js"],"app":["/app-2bd32f5346912e1f72ba.js"],"component---src-pages-404-js":["/component---src-pages-404-js-f0e1bb9b40a6124adca8.js"],"component---src-pages-index-js":["/component---src-pages-index-js-2836ba1d91d2707a19a6.js"],"component---src-template-archive-js":["/component---src-template-archive-js-2f569590a3de5c4cc354.js"],"component---src-template-blog-details-js":["/component---src-template-blog-details-js-6effa60f0b9129ae7c3d.js"],"component---src-template-category-post-js":["/component---src-template-category-post-js-e537a488f1cbef7de13b.js"],"component---src-template-project-details-js":["/component---src-template-project-details-js-9a3c0886943a0d2080e1.js"],"component---src-template-tag-template-js":["/component---src-template-tag-template-js-7290644d00f80b31de3d.js"]}');
